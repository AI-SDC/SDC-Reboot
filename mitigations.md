...
- different types of machine learning projects
...
- you can demonstrate the training data has been pseudonymised to the extent you would publish it (down a tier in the Turing categorisation): **affects impact**
...
-   for example (explain caveats= doesn't reduce likelihood to all risks class disclosure)
